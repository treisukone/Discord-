...
TOKEN = "MTUxMzE3MDQzNDgwNjI1NTYyNg.Gbyrsj.Tx6742mFcUryuxzWP8IxXFfrSe3vT-tNp0Ue5E" 
...
# ── MEMORY ──
user_history = {}      # {guild_id: {user_id: [last 3 messages]}}
last_reply = {}        # {channel_id: str}
reply_cooldown = {}    # {channel_id: datetime}
...
def pick(pool, channel_id):
    """pick random, avoid repeating last reply in channel"""
